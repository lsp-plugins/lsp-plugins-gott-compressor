...
LSP_AUDIO_JACK_LIB_VERSION              := 1.0.2
LSP_AUDIO_JACK_LIB_NAME                 := lsp-audio-jack-lib
LSP_AUDIO_JACK_LIB_TYPE                 := bin
...
LSP_AUDIO_PIPEWIRE_LIB_VERSION 			:= 1.0.3
